    ...
    <>
      ...
      <section className="landing" id="home" data-dark="true">
        <video
          ...
          playsInline
          preload="auto"
          poster="https://res.cloudinary.com/dphe5xhwj/video/upload/v1765006554/v22_fqhc6v.jpg"
          className="video-bg"
        >
          <source src="https://res.cloudinary.com/dphe5xhwj/video/upload/q_auto:low,f_auto,vc_auto/v1765006554/v22_fqhc6v.mp4" type="video/mp4" />
        </video>
        ...
        <div className="hero-content-wrapper">
          <div className="image-cursor-wrapper">
            <div className="image-box">
              <img src="https://res.cloudinary.com/dphe5xhwj/image/upload/v1765008353/picc_b1mz8k.png" alt="Design Preview" className="image" />
      ...
      <section className="card-section" id="projects" data-dark="true">
        ...
        <div className="card-grid ">
          <a href="https://github.com/pratik-j-mahajan/-Paisa-A-Finance-Investment-Management-App" target="_blank" className="card">
          ...
          <a href="https://github.com/pratik-j-mahajan/Genora-One-A-Saas-Platform" target="_blank" className="card">
            <div className="card-image">
      ...
      <div className="landing-layers" data-dark="true">
        ...
        <section className="resume-section">
          <div className="resume-content">
            ...
            <a
              href="https://github.com/pratik-j-mahajan/resume"
              target="_blank"
              rel="noopener noreferrer"
