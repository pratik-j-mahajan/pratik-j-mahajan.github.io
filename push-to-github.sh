...
git config user.name "pratik-j-mahajan"
git config user.email "mahajanpratik0612@gmail.com"
...
git remote add origin https://github.com/pratik-j-mahajan/pratik-j-mahajan.github.io.git
